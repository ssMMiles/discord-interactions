...
type SelectMenuDataType = APIMessageRoleSelectInteractionData;
export class RoleSelectMenuContext<S = never> extends BaseSelectMenuContext<S, SelectMenuDataType> {
