...
[@discord-interactions/core](../globals.md) / MentionableSelectMenu

# Class: MentionableSelectMenu

Defined in: [app/components/select\_menus/MentionableSelectMenu.ts:6](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/MentionableSelectMenu.ts#L6)

## Extends

- [`ComponentBase`](ComponentBase.md)\<`APIMentionableSelectComponent`, `MentionableSelectMenuBuilder`, [`MentionableSelectMenuContext`](MentionableSelectMenuContext.md)\>

## Constructors

### Constructor

> **new MentionableSelectMenu**(`id`, `builder`, `handler?`): `MentionableSelectMenu`

Defined in: [app/components/select\_menus/MentionableSelectMenu.ts:11](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/MentionableSelectMenu.ts#L11)
...
[`MentionableSelectMenuContext`](MentionableSelectMenuContext.md)
...
> **createInstance**(`state`): `MentionableSelectMenuBuilder`

Defined in: [app/components/select\_menus/MentionableSelectMenu.ts:21](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/MentionableSelectMenu.ts#L21)
...
> **setAllowExpired**(`value`): `MentionableSelectMenu`
...
> **setId**(`id`): `MentionableSelectMenu`
