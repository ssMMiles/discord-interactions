...
[@discord-interactions/core](../globals.md) / RegisteredEntryPointCommand

# Class: RegisteredEntryPointCommand

Defined in: [app/commands/EntryPointCommand.ts:25](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/commands/EntryPointCommand.ts#L25)

## Extends

- `RegisteredCommandBase`\<`EntryPointCommandBuilder`, [`EntryPointCommandContext`](EntryPointCommandContext.md)\>

## Constructors

### Constructor

> **new RegisteredEntryPointCommand**(`manager`, `command`): `RegisteredEntryPointCommand`
...
`RegisteredCommandBase< EntryPointCommandBuilder, EntryPointCommandContext >.constructor`
