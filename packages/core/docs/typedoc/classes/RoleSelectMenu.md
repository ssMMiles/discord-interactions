...
[@discord-interactions/core](../globals.md) / RoleSelectMenu

# Class: RoleSelectMenu

Defined in: [app/components/select\_menus/RoleSelectMenu.ts:6](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/RoleSelectMenu.ts#L6)

## Extends

- [`ComponentBase`](ComponentBase.md)\<`APIRoleSelectComponent`, `RoleSelectMenuBuilder`, [`RoleSelectMenuContext`](RoleSelectMenuContext.md)\>

## Constructors

### Constructor

> **new RoleSelectMenu**(`id`, `builder`, `handler?`): `RoleSelectMenu`

Defined in: [app/components/select\_menus/RoleSelectMenu.ts:11](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/RoleSelectMenu.ts#L11)
...
[`RoleSelectMenuContext`](RoleSelectMenuContext.md)
...
> **createInstance**(`state`): `RoleSelectMenuBuilder`

Defined in: [app/components/select\_menus/RoleSelectMenu.ts:21](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/RoleSelectMenu.ts#L21)
...
> **setAllowExpired**(`value`): `RoleSelectMenu`
