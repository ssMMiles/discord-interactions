...
[@discord-interactions/core](../globals.md) / UserSelectMenu

# Class: UserSelectMenu

Defined in: [app/components/select\_menus/UserSelectMenu.ts:6](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/UserSelectMenu.ts#L6)

## Extends

- [`ComponentBase`](ComponentBase.md)\<`APIUserSelectComponent`, `UserSelectMenuBuilder`, [`UserSelectMenuContext`](UserSelectMenuContext.md)\>

## Constructors

### Constructor

> **new UserSelectMenu**(`id`, `builder`, `handler?`): `UserSelectMenu`

Defined in: [app/components/select\_menus/UserSelectMenu.ts:11](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/UserSelectMenu.ts#L11)
...
[`UserSelectMenuContext`](UserSelectMenuContext.md)
...
> **createInstance**(`state`): `UserSelectMenuBuilder`

Defined in: [app/components/select\_menus/UserSelectMenu.ts:21](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/core/src/app/components/select_menus/UserSelectMenu.ts#L21)
...
> **setAllowExpired**(`value`): `UserSelectMenu`
