...
[@discord-interactions/builders](../globals.md) / MentionableSelectMenuBuilder

# Class: MentionableSelectMenuBuilder

Defined in: [packages/builders/src/components/select\_menus/MentionableSelectMenuBuilder.ts:12](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/builders/src/components/select_menus/MentionableSelectMenuBuilder.ts#L12)
...
> **new MentionableSelectMenuBuilder**(`data?`): `MentionableSelectMenuBuilder`

Defined in: [packages/builders/src/components/select\_menus/MentionableSelectMenuBuilder.ts:13](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/builders/src/components/select_menus/MentionableSelectMenuBuilder.ts#L13)

#### Parameters

##### data?

`Partial`\<`APIMentionableSelectComponent`\>
...
> **setDefaultValues**(...`defaultValues`): `this`

Defined in: [packages/builders/src/components/select\_menus/MentionableSelectMenuBuilder.ts:21](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/builders/src/components/select_menus/MentionableSelectMenuBuilder.ts#L21)
...
...`APISelectMenuDefaultValue`\<`Role` \| `User`\>[]

Default values, each with an id and a type of "user" or "role"
...
Defined in: [packages/builders/src/components/select\_menus/MentionableSelectMenuBuilder.ts:27](https://github.com/ssMMiles/discord-interactions/blob/6f83de924580b28f6a9d2d51d6c72bfcd26a7e85/packages/builders/src/components/select_menus/MentionableSelectMenuBuilder.ts#L27)
