...
[src/commands/options/user.ts:5](https://github.com/ssMMiles/interactions.ts/blob/df1cc9e/packages/builders/src/commands/options/user.ts#L5)
...
[src/commands/options/user.ts:7](https://github.com/ssMMiles/interactions.ts/blob/df1cc9e/packages/builders/src/commands/options/user.ts#L7)
